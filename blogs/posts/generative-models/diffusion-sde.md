...
$$dx_t=u(x_t, t)dt+\sigma_tdW$$

其中 `W` 服从一个维纳过程，即：

$$
dW\sim\mathcal{N}(0,t\cdot I)
$$

离散化：

$$x_{t+\Delta t}=x_t+u(x_t,t)\Delta t+\sigma_t\sqrt{\Delta t}\cdot\epsilon,\epsilon\sim\mathcal{N}(0,I)$$
...
$$
\mathbb{E}[\epsilon]=0,\mathbb{E}[\epsilon^2]=1
$$
...
提出来，并在最前面提出一个负号，以完全匹配 FP 方程的标准格式：
...
在生成式 AI 领域的论文中，为了方便，大家习惯继续使用物理时间：
